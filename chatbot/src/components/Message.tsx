...
export const Message = ({ message }: { message: MessageType }) => {
  console.log(linkify("Check out this link: https://example.com"));
  ...
  return message.role === "user" ? (
    ...
    <div className="m-2 flex flex-col items-start">
      <div
        className=" w-3/4 self-start break-words rounded-bl-none rounded-br-lg rounded-tl-lg rounded-tr-lg bg-slate-300 p-2 text-left text-black"
        dangerouslySetInnerHTML={{ __html: richContent }}
      />
